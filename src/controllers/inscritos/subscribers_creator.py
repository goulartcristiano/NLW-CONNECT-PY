...
class SubscriberCreator:
    ...
    def __check_sub(self, subscribe_email: str, evento_id: int) -> None:
        response = self.__subs_repo.select_subscriber(subscribe_email, evento_id)
        if response: raise Exception("Inscrito ja existe!")
